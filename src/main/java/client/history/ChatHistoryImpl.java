...
import static total.MessagesText.HISTORY_FILENAME_PATTERN;


public class ChatHistoryImpl implements client.ChatHistory<Message> {
    ...
    private String stringFromMessage(Message message) {
        return message.getCreated() + ">" + message.getUserName() + ">" + message.getMessageText();
    }
